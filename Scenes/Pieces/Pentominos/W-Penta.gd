...
func _init():
	var pos0 = [Vector2(1,1),Vector2(2,1),Vector2(2,2),Vector2(3,2),Vector2(3,3)]
	var pos1 = [Vector2(3,1),Vector2(3,2),Vector2(2,2),Vector2(2,3),Vector2(1,3)]
	var pos2 = [Vector2(1,1),Vector2(1,2),Vector2(2,2),Vector2(2,3),Vector2(3,3)]
	var pos3 = [Vector2(3,1),Vector2(2,1),Vector2(2,2),Vector2(1,2),Vector2(1,3)]
	positions = [pos0,pos1,pos2,pos3]
	block_color = "BlueBlock"
