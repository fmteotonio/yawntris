...
func _init():
	var pos0 = [Vector2(1,0),Vector2(0,1),Vector2(1,1),Vector2(2,1)]
	var pos1 = [Vector2(2,1),Vector2(1,0),Vector2(1,1),Vector2(1,2)]
	var pos2 = [Vector2(1,2),Vector2(2,1),Vector2(1,1),Vector2(0,1)]
	var pos3 = [Vector2(0,1),Vector2(1,2),Vector2(1,1),Vector2(1,0)]
